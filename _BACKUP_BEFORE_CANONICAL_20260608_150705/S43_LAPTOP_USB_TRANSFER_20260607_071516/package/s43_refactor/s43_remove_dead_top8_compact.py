...
TARGET = Path("s43.py")
NAME = "top8_compact_panel"
WS_NAME = "_ws_top8_compact_panel"
...
if ws_refs:
    print("ABORT: _ws_top8_compact_panel references exist; inspect first.")
    sys.exit(1)

external_name_refs = [n for n in name_refs if getattr(n, "lineno", None) != fn.lineno]
if external_name_refs:
    print("ABORT: non-call name references exist; inspect first.")
    sys.exit(1)
...
backup = TARGET.with_name(f"s43.py.before_remove_dead_top8_compact_{stamp}")
...
print("OK: dead top8_compact_panel removed and s43.py compiles.")
...
if not found:
    print("No remaining top8_compact_panel references found.")
