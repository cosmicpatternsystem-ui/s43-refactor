...
echo "== S43 Deep Refactor Guard FAST =="

TS=$(date +%Y%m%d_%H%M%S)

cat > s43_deep_refactor_guard_fast.py <<'PY'
#!/usr/bin/env python3
import ast
import time
...
chmod +x s43_deep_refactor_guard_fast.py

python s43_deep_refactor_guard_fast.py
python -m py_compile s43.py

echo "== DONE =="
echo "Run again:"
echo "python s43_deep_refactor_guard_fast.py"
