...
echo "=== S43 ARCHITECTURE ANALYZER ==="
...
mkdir -p s43_project/architecture

cat << 'PY' > s43_project/analyze_architecture.py
import ast
...
python s43_project/analyze_architecture.py

echo "[2] reports created"
ls s43_project/architecture
