...
## Required Before GO
1. Capture reproducible evidence for governance validation.
2. Record self-test and validation outputs in repo-retained evidence form.
3. Separate runtime noise and incidental artifacts from sign-off evidence.
4. Confirm artifact provenance, repeatability, and reviewability.