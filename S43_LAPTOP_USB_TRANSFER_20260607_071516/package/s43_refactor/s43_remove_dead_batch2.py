...
TARGET = Path("s43.py")
TARGET_RUN_INDEX = 2
REMOVE = ["_ring_health", "wallet_summary_panel", "wallet_detail_panel"]
...
backup = TARGET.with_name(f"s43.py.before_remove_dead_batch2_{stamp}")
...
print("OK: batch2 removed and s43.py compiles.")
